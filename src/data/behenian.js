...
export const BEHENIAN = {
  "Algol": { latin: "Caput Algol", stone: "Diamond", herb: "Black hellebore & mugwort",
    nature: "Saturn & Jupiter (Agrippa II.31)", ptolemy: "agrees (Perseus = Saturn & Jupiter; Robson 1923 follows Ptolemy here) — the Saturn/Mars reading is a later-20th-century gloss (Ebertin school)",
    image: "The head of a man with a bloody neck.",
    virtue: "Success in petitions; boldness and magnanimity; preserves the body; protects against witchcraft and reflects curses back upon their senders. Hermes adds: facit vindictam super quos volueris — it works vengeance on whom you will; handle accordingly" },
  "Alcyone": { latin: "Pleiades", stone: "Crystal (rock crystal)", herb: "Fennel, with frankincense",
    ...
    virtue: "Increases and preserves eyesight; assembles spirits; raises winds; reveals secret, hidden, and lost things. Agrippa's full compound adds the stone Diadochos, the herb Diacedon, and — uniquely — quicksilver: fennel seed with frankincense and quicksilver set under crystal. Hermes' strongest clause: spiritus mortuorum vocat — it calls the spirits of the dead" },
  ...
  "Sirius": { latin: "Canis Major — the greater Dog-star", stone: "Beryl — the working set in gold (Hermes: positum auro sub berillo)", herb: "Savine juniper, mugwort, dragonwort",
  ...
  "Algorab": { latin: "Ala Corvi — Wing of the Crow", stone: "Black onyx", herb: "Burdock (seed, leaves, root); henbane, comfrey",
    ...
    variant: "Agrippa II.31 gives both wings — the right wing at 7° Libra and the left at 13° Libra (he names neither star; the Gienah/Algorab identification is modern convention). Either serves." },
